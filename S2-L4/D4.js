...
console.log(epify("EPICODE Sends his regards"))
console.log(epify("Sends his regards"))
...
console.log(upperFirst("epicode sends his regards"));
...
function giveMeRandom (n){
    const numerirandom = []
    for (let i = 0; i < n; i++){
    numerirandom.push(Math.random()*10);
   }return numerirandom
}
